...
Component that contains important links or buttons, which helps with navigating through website. It may contains dropdown menus for better clarity. Usually it is located on the top of the website.
